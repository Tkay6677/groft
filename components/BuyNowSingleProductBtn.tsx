...
const BuyNowSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-red-500 hover:border-red-500 border-1 font-normal bg-red-500 text-white hover:bg-white hover:scale-110 hover:text-red-500 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Buy Now
    </button>
  );
