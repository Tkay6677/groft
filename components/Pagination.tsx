...
const Pagination = () => {
  ...
  return (
    <div className="join flex justify-center py-16">
      <button
        className="join-item btn btn-lg bg-red-500 text-white hover:bg-white hover:text-black"
        onClick={() => decrementPage()}
      >
        «
      </button>
      <button className="join-item btn btn-lg bg-red-500 text-white hover:bg-white hover:text-black">
        Page {page}
      </button>
      <button
        className="join-item btn btn-lg bg-red-500 text-white hover:bg-white hover:text-black"
